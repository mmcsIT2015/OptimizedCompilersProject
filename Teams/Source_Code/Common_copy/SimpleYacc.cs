...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{25,20,11,4,16,40,15,48,22,56,13,60},new int[]{-11,5,-7,67,-6,9,-2,10,-12,38,-8,39,-9,47,-13,53,-10,59});
    states[5] = new State(new int[]{12,6,4,7});
    states[6] = new State(-31);
    states[7] = new State(new int[]{25,20,11,4,16,40,15,48,22,56,13,60},new int[]{-7,8,-6,9,-2,10,-12,38,-8,39,-9,47,-13,53,-10,59});
    ...
    states[12] = new State(new int[]{17,13,18,25,19,33,20,35,12,-14,4,-14,15,-14,14,-14});
    states[13] = new State(new int[]{25,20,23,21,9,22},new int[]{-5,14,-3,32,-4,31,-2,19});
    states[14] = new State(new int[]{5,15,6,27,17,-16,18,-16,19,-16,20,-16,12,-16,4,-16,15,-16,14,-16,10,-16,21,-16});
    states[15] = new State(new int[]{25,20,23,21,9,22},new int[]{-3,16,-4,31,-2,19});
    states[16] = new State(new int[]{7,17,8,29,5,-21,6,-21,17,-21,18,-21,19,-21,20,-21,12,-21,4,-21,15,-21,14,-21,10,-21,21,-21});
    ...
    states[26] = new State(new int[]{5,15,6,27,17,-17,18,-17,19,-17,20,-17,12,-17,4,-17,15,-17,14,-17,10,-17,21,-17});
    states[27] = new State(new int[]{25,20,23,21,9,22},new int[]{-3,28,-4,31,-2,19});
    states[28] = new State(new int[]{7,17,8,29,5,-22,6,-22,17,-22,18,-22,19,-22,20,-22,12,-22,4,-22,15,-22,14,-22,10,-22,21,-22});
    states[29] = new State(new int[]{25,20,23,21,9,22},new int[]{-4,30,-2,19});
    states[30] = new State(-25);
    states[31] = new State(-23);
    states[32] = new State(new int[]{7,17,8,29,5,-20,6,-20,17,-20,18,-20,19,-20,20,-20,12,-20,4,-20,15,-20,14,-20,10,-20,21,-20});
    states[33] = new State(new int[]{25,20,23,21,9,22},new int[]{-5,34,-3,32,-4,31,-2,19});
    states[34] = new State(new int[]{5,15,6,27,17,-18,18,-18,19,-18,20,-18,12,-18,4,-18,15,-18,14,-18,10,-18,21,-18});
    states[35] = new State(new int[]{25,20,23,21,9,22},new int[]{-5,36,-3,32,-4,31,-2,19});
    states[36] = new State(new int[]{5,15,6,27,17,-19,18,-19,19,-19,20,-19,12,-19,4,-19,15,-19,14,-19,10,-19,21,-19});
    states[37] = new State(new int[]{5,15,6,27,17,-15,18,-15,19,-15,20,-15,12,-15,4,-15,15,-15,14,-15,10,-15,21,-15});
    states[38] = new State(-8);
    states[39] = new State(-9);
    states[40] = new State(new int[]{25,20,11,4,16,40,15,48,22,56,13,60},new int[]{-7,41,-6,9,-2,10,-12,38,-8,39,-9,47,-13,53,-10,59});
    states[41] = new State(new int[]{15,42});
    states[42] = new State(new int[]{9,43});
    states[43] = new State(new int[]{25,20,23,21,9,22},new int[]{-1,44,-5,37,-3,32,-4,31,-2,19});
    states[44] = new State(new int[]{10,45,17,13,18,25,19,33,20,35});
    ...
    states[51] = new State(new int[]{25,20,11,4,16,40,15,48,22,56,13,60},new int[]{-7,52,-6,9,-2,10,-12,38,-8,39,-9,47,-13,53,-10,59});
    states[52] = new State(-33);
    states[53] = new State(new int[]{21,54,12,-11,4,-11,15,-11,14,-11});
    states[54] = new State(new int[]{25,20,23,21,9,22},new int[]{-1,55,-5,37,-3,32,-4,31,-2,19});
    states[55] = new State(new int[]{17,13,18,25,19,33,20,35,21,-6,12,-6,4,-6,15,-6,14,-6});
    states[56] = new State(new int[]{21,57});
    states[57] = new State(new int[]{25,20,23,21,9,22},new int[]{-1,58,-5,37,-3,32,-4,31,-2,19});
    states[58] = new State(new int[]{17,13,18,25,19,33,20,35,21,-5,12,-5,4,-5,15,-5,14,-5});
    states[59] = new State(-12);
    states[60] = new State(new int[]{9,61});
    states[61] = new State(new int[]{25,20,23,21,9,22},new int[]{-1,62,-5,37,-3,32,-4,31,-2,19});
    states[62] = new State(new int[]{10,63,17,13,18,25,19,33,20,35});
    states[63] = new State(new int[]{25,20,11,4,16,40,15,48,22,56,13,60},new int[]{-7,64,-6,9,-2,10,-12,38,-8,39,-9,47,-13,53,-10,59});
    states[64] = new State(new int[]{14,65,12,-29,4,-29,15,-29});
    states[65] = new State(new int[]{25,20,11,4,16,40,15,48,22,56,13,60},new int[]{-7,66,-6,9,-2,10,-12,38,-8,39,-9,47,-13,53,-10,59});
    states[66] = new State(-30);
    states[67] = new State(-3);

    rules[1] = new Rule(-15, new int[]{-14,2});
    rules[2] = new Rule(-14, new int[]{-12});
    rules[3] = new Rule(-11, new int[]{-7});
    rules[4] = new Rule(-11, new int[]{-11,4,-7});
    ...
    rules[32] = new Rule(-8, new int[]{16,-7,15,9,-1,10,4});
...
{ CurrentSemanticValue.stVal = ValueStack[ValueStack.Depth-1].blVal; }
        break;
      case 9: // statement -> do_while
{ CurrentSemanticValue.stVal = ValueStack[ValueStack.Depth-1].stVal; }
        break;
      case 10: // statement -> while
{ CurrentSemanticValue.stVal = ValueStack[ValueStack.Depth-1].stVal; }
        break;
      case 11: // statement -> cout
{ CurrentSemanticValue.stVal = ValueStack[ValueStack.Depth-1].ioVal; }
        break;
...
{ CurrentSemanticValue.blVal = ValueStack[ValueStack.Depth-2].blVal; }
        break;
      case 32: // do_while -> DO, statement, WHILE, LBRACKET, expr, RBRACKET, SEMICOLON
