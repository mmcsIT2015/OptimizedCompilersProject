...
1. Определение всех естественных циклов
2. Определение вложенности естественных циклов
3. Определение глубины CFG
4. Изменение итерационного алгоритма (__TrueDevelopers__)
5. Ответственность за документацию (__Альфа__)
6. Редактирование тестов (__Альфа__)
