...
Для передения текстового или .md файла в формат DOCX, PDF использовать pandoc и модуль MikTeX
...
- Перевод документа в PDF или DOCX формат производится одной командой: 

    pandoc --latex-engine=xelatex -V mainfont="Sitka Text" --highlight-style tango inputfilename.md -o outputfilename.pdf (.docx)
